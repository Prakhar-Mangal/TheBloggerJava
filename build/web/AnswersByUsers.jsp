<%-- 
    Document   : AnswersByUsers
    Created on : 25 Mar, 2019, 11:51:39 AM
    Author     : prakhar
--%>
...
<style>.blue{
    ...
    <%
           ...
           PreparedStatement ps1=con.prepareStatement("select distinct qid from answer where uname=?");
  ...
  <body class="blue">
    ...
    PreparedStatement ps2=con.prepareStatement("select * from question where qid=?");
           ps2.setInt(1, qid);
    ...
    <div class="container col-auto breadcrumb">
      <h4>Q<%=(++i)%>. <%= rs2.getString(2) %></h4>
    </div>
 <%
        int j=0;
        
    PreparedStatement ps3=con.prepareStatement("select * from answer where qid=? and uname=?");
           ps3.setInt(1, qid);
